 ...
 * @author carlo_000
 */
public class FormColegio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        escritorio.setBackground(new java.awt.Color(0, 255, 153));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
         escritorio.removeAll();
        escritorio.repaint();
        FormMaterias fm = new FormMaterias();
        fm.setVisible(true);
        escritorio.add(fm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormColegio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormColegio().setVisible(true);
            }
        });
    }
